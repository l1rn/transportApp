<<<<<<< HEAD:client/src/components/admin/adminRoutesManage/DeleteRouteView.vue
<template>
...
<style scoped lang="sass">
@import "@/assets/styles/adminObjects/delete-page"
>>>>>>> 8a6cce314fb11973cf56c7551e6cfb08585b32bb:client/src/components/admin/adminRoutesManage/DeleteRoute.vue
</style>