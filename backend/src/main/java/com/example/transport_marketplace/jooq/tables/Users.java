...
public class Users extends TableImpl<UsersRecord> {
     ...
     */
    public final TableField<UsersRecord, Double> BALANCE = createField(DSL.name("balance"), SQLDataType.DOUBLE, this, "");
    ...
    public RefreshTokensPath refreshTokens() {
        if (_refreshTokens == null)
            _refreshTokens = new RefreshTokensPath(this, null, Keys.REFRESH_TOKENS__FK1LIH5Y2NPSF8U5O3VHDB9Y0OS.getInverseKey());
    ...
    public BookingsPath bookings() {
        if (_bookings == null)
            _bookings = new BookingsPath(this, null, Keys.BOOKINGS__FKEYOG2OIC85XG7HSU2JE2LX3S6.getInverseKey());
    ...
    public PaymentsPath payments() {
        if (_payments == null)
            _payments = new PaymentsPath(this, null, Keys.PAYMENTS__FKJ94HGY9V5FW1MUNB90TAR2EJE.getInverseKey());
    ...
    public DevicesPath devices() {
        if (_devices == null)
            _devices = new DevicesPath(this, null, Keys.DEVICES__FKRFBRI1YMRWYWDYDC4DGYWE1BT.getInverseKey());
    ...
    public List<Check<UsersRecord>> getChecks() {
        return Arrays.asList(
            Internal.createCheck(this, DSL.name("users_role_check"), "(((role)::text = ANY ((ARRAY['ROLE_USER'::character varying, 'ROLE_ADMIN'::character varying, 'ROLE_SUPERADMIN'::character varying])::text[])))", true)
        );
    }
